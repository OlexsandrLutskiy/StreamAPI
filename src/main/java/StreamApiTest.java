...
//        StreamApiTest api = new StreamApiTest();
//        String[] arr = new String[]{"Ivan", "Petro", "Mykola", "Andriy", "Oleksandr", "Oleh"};
//        List<String> names = Arrays.asList(arr);
//
//        System.out.println(api.oddIndexNames(names));
//
//        System.out.println(api.getReverseList(names));
//
//        System.out.println(api.getDigit(api.getNumbers()));
//
//        Stream<String> first = Stream.of("a", "b", "c", "d");
//        Stream<String> second = Stream.of("1", "2", "3");
//        System.out.println(api.zip(first, second).collect(Collectors.toList()));
//
//    }
}
